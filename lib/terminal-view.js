...
export default class TerminalView {
  ...
  observeAndApplyThemeStyles() {
    ...
    this.disposables.add(atom.config.onDidChange('terminal-tab-fork.matchTheme', this.applyThemeStyles.bind(this)));
  ...
  observeAndApplyTypeSettings() {
    ...
    this.disposables.add(atom.config.onDidChange('terminal-tab-fork.fontFamily', this.applyTypeSettings.bind(this)));
  ...
  applyThemeStyles() {
    ...
    if (!atom.config.get('terminal-tab-fork.matchTheme')) {
  ...
  applyTypeSettings() {
    ...
    //
    const fontFamily = atom.config.get('terminal-tab-fork.fontFamily')
